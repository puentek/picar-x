...
color_dict = {'red':[0,4],'orange':[5,18],'yellow':[22,37],'green':[42,85],'blue':[92,95], 'blue_2':[96,110],'purple':[115,165],'red_2':[165,180]}  #Here is the range of H in the HSV color space represented by the color
...
def color_detect(img,color_name):
    ...
    if color_type == 'blue':
            mask_2 = cv2.inRange(hsv, (color_dict['blue_2'][0],0,0), (color_dict['blue_2'][1],255,255)) 
